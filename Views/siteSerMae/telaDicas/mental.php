...
<body>
    ...
    <div class="nav-mental">
        <div class="name-dica">
            <div class="name-add">
                <h2>SaúdeMental</h2>
                <i class="fa-solid fa-plus add-2" id="open-modal"></i>
            </div>
                        ...
                        <div class="corpo-add-input"> 
                            <span class="add-input">
                                ...
                                <!-- Modal com IDs exclusivos -->
                                    <div id="myModal1" class="modal-desc-1">
                                        <div class="modal-content-desc-1">
        ...
        <div class="previous">
            ...
            <!--inicio dropdwon
            <div class="select-dicas">
                <div class="select-btn-dicas">
                    <span class="sBtn-text">Categoria</span>
                    <i class="fa-solid fa-caret-down"></i>
                </div>
                <ul class="option-dicas">
                    <li class="option">
                        <i class="fa-solid fa-user-doctor"></i>
                        <span class="option-text">Dicas médicas</span>
                    </li>
                    <li class="option">
                        <i class="fa-solid fa-user-doctor"></i>
                        <span class="option-text">Dicas especializadas</span>
                    </li>
                    <li class="option">
                        <i class="fa-solid fa-user-doctor"></i>
                        <span class="option-text">Dicas de usuárias</span>
                    </li>
...
<!--dropdown inicio-->
<script>
    optionMenu = document.querySelector(".select-dicas");
    selectBtn = optionMenu.querySelector(".select-btn-dicas");
