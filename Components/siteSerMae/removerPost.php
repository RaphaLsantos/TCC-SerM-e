...
if (isset($_GET['publicacaoId'])) {
    ...
    header('Location: ../../Views/siteSerMae/perfilUser/perfil.php?mensagem=Publicação+de+nº+' . $publicacaoId . '+Excluída+com+Sucesso');    echo "Publicação de nº " . $publicacaoId . " Excluida";
} else {
